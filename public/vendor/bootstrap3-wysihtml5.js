!function($, wysi) {
    ...
    var tpl = {
        ...
        "color": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
                ...
                "<span class='current-color'>" + locale.colours.theme + "</span>&nbsp;<b class='caret'></b>" +
                "</a>" +
                "<ul class='dropdown-menu'>" +
                "<li><div class='wysihtml5-colors' data-wysihtml5-command-value='theme'></div><a class='wysihtml5-colors-title' data-wysihtml5-command='foreColor' data-wysihtml5-command-value='theme'>" + locale.colours.theme + "</a></li>" +
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["/stylesheets/bootstrap3-wysiwyg5-color.css"], // (path_to_project/lib/css/bootstrap3-wysiwyg5-color.css)
        locale: "en"
    };
